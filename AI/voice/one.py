...
droid.recorderStartMicrophone('/sdcard/Music/111.mp3')
print("请提问：")
time.sleep(3)
print("提问结束")
droid.recorderStop()
...
# 移动文件
shutil.move(r'/sdcard/Music/111.mp3', r'/home/voice/222.mp3')

# 鉴权参数
ak = 'D4RXATHPNMOAKHVN2PUI'             # 参考https://support.huaweicloud.com/sdkreference-sis/sis_05_0003.html
sk = 'GI8wjAIk94QPieJPFD0oCc5FFUQldch5EESDJAoK'             # 参考https://support.huaweicloud.com/sdkreference-sis/sis_05_0003.html
region = 'cn-north-4'         # region，如cn-north-4
project_id = '0d3e411bb080f4412f30c01997476688'     # 同region一一对应，参考https://support.huaweicloud.com/api-sis/sis_03_0008.html
...
path = '222.mp3'  # 文件位置, 需要具体到文件，如D:/test.wav
path_audio_format = 'mp3'  # 音频格式，如wav等，详见api文档
path_property = 'chinese_16k_travel'  # language_sampleRate_domain, 如chinese_8k_common，详见api文档
